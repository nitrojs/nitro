...
declare global {
  ...
  var __VITE_ENVIRONMENT_RUNNER_IMPORT__: (environmentName: string, id: string) => Promise<any>;
}
...
globalThis.__VITE_ENVIRONMENT_RUNNER_IMPORT__ = async function (
  ...
  return await globalThis.__nitro_vite_envs__[environmentName].runner.import(id);
};
