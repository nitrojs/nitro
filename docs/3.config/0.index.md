...
Additional script-like source file extensions to treat like the built-in JS and TS server files. Used for file scanning, entry resolution, and dev reload detection. Your bundler still has to provide the actual transform for the extension.
