...
If you need to hide the automatically generated specficiation for Internal tagged routes (e.g. _scalar, _swagger, _nuxt) you can disable specific tags to be exposed:
