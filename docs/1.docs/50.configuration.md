...
::tip
Nitro loads the configuration using [c12](https://github.com/unjs/c12), giving more possibilities such as using a `.nitrorc` file in the current working directory or in your home directory.
::
