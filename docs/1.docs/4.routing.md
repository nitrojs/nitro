...
Nitro supports the Web standard format to define request handlers, but also any standard-compatible librairies, such as [Elysia](https://elysiajs.com/), [h3](https://h3.dev) or [Hono](https://hono.dev).
