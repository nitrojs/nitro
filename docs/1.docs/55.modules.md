...
| `vite:compile:before` | `(nitro) => void` | Vite builder only. After public assets are copied and prerendering finished, right before the server bundle is built. Use it to emit extra files into the public output directory. |
