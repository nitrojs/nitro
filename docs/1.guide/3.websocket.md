...
<!-- automd:file code src="../../examples/websocket/server/routes/_ws.ts" -->
...
Use a client to connect to server. Example: (`server/routes/websocket-client.ts`)

<!-- automd:file code src="../../examples/websocket/server/routes/websocket-client.ts" -->
...
Now you can try it on `/websocket-client` route!
